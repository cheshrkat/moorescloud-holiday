...
Getting "Holiday by Moorescloud":http://moorescloud.com/index.html#holiday to do some relatively simple things in a few different languages - from the simple on/off to chase, comet and gradient effects.
...
This one's a little different as you have to put it on the holiday (to avoid CORS issues) to actually control the lights. If you view it locally it still does the visualisation but it won't actually affect the lights.
