...
Getting "Holiday by Moorescloud":http://moorescloud.com/index.html#holiday to do core things in a few different languages - from the simple on/off to chase, comet and gradient effects.
