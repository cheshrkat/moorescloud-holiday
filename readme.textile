...
This one's a little different as you have to put it on the holiday to avoid CORS issues.
...
# Then either...
## Open Terminal/bash shell in @/javascript/@ and use @scp * holiday@yourholidaysname:/home/holiday/holideck/iotas/www/apps/test/
@
