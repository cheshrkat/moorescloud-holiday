...
I've tried to write this readme without assuming too much knowledge, as I know a few people use their Moorescloud Holiday to try out coding with their kids. If you know things like colour formats, just skip those sections.
...
Since the official docs aren't online any more, this readme collects what I could; has some basic info on setting things up; and a copy of the PDF in case (like me) you lost your instruction book.
...
It's effectively a simulator and alternative UI to control the Holiday. It wasn't really what I intended to do but that's how it turned out :)
...
## @cd /javascript/@
## @scp * holiday@yourholidaysname:/home/holiday/holideck/iotas/www/apps/test/@
